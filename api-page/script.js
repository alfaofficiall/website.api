document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        setContent('page', 'textContent', settings.name || "ＡＬＦＡ ＯＦＦＩＣＩＡ UI");
        setContent('wm', 'textContent', `© 2025 ${settings.apiSettings.creator}. All rights reserved.` || "© 2025 ＡＬＦＡ ＯＦＦＩＣＩＡ. All rights reserved.");
        setContent('header', 'textContent', settings.name || "ＡＬＦＡ ＯＦＦＩＣＩＡ UI");
        setContent('name', 'textContent', settings.name || "ＡＬＦＡ ＯＦＦＩＣＩＡ UI");
